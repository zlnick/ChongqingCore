...
* meta.profile ^comment = "在新增、修改等操作中，卫生机构主数据需引用profile，格式为http://[标准发布地址]/StructureDefinition/hc-healthcare-organization|0.1.5"
...
* meta.profile = "http://fhir.cq.hc/StructureDefinition/hc-healthcare-organization|0.1.5"
* active = true 
...
* extension[HealthcareInstitutionsTypeExtension].valueCoding = HealthcareInstitutionsTypeCS#C210 "中心卫生院"
* extension[HospitalLevelExtension].valueCoding = CNHospitalLevelCS#12 "二级未评"
* extension[EconomicIndustryClassificationExtension].valueCoding = NationalEconomicIndustryClassificationCS#110 "国有全资"
* extension[HospitalManagementTypeExtension].valueCoding = CNHospitalManagementTypeCS#1 "非营利性医疗机构"
* extension[SupervisedByExtension].valueReference.type = "Organization"
* extension[SupervisedByExtension].valueReference.identifier.type = ChineseIdentifierTypeCS#MOI "机构主索引号码"
...
* partOf.reference = "http://example.org/fhir/r4/Organization/2"
